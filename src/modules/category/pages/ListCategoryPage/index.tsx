...
import { deleteCategory, getListCategories } from '@/apis/categories.api';
...
import { MCategoryTable } from '../../components/MCategoryTable';
...
const ListCategoriesPage = () => {
  ...
  const listData = useMemo<IGetCategoryResponse[]>(
  ...
  return (
    <Box>
      <Stack
        ...
        mb={3}
      >
        <Typography variant="page-title">Category</Typography>
