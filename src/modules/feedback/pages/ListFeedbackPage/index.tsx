...
import { deleteFeedback, getFeedbacks } from '@/apis/feedback.api';
...
import { MFeedbackTable } from '../../components';
...
const ListFeedbackPage = () => {
  ...
  const { data, refetch, isLoading, isError } = useQuery({
    ...
    queryFn: () => getFeedbacks(filter),
  });

  const listData = useMemo<IGetFeedbackResponse[]>(
  ...
  return (
    <Box>
      <Stack
        ...
        mb={3}
      >
        <Typography variant="page-title">Feedback</Typography>
